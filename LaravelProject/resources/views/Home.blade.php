...
<script>
        ...
        function startScooterAnimation() {
            ...
            if (scooter) {
              ...
              if(hornSound){
                ...
                console.log('the sound is not found!')
              }

                // Logique pour réinitialiser la position après animation
                setTimeout(() => {
                    scooter.style.left = "0"; // Retourne à gauche
                }, 1000); // Change le délai si nécessaire
            } else {
                console.log("Scooter element not found!");
            }
        }
    ...
    <div class="hero container py-5 my-5">
      <div class="row flex-lg-row-reverse align-items-center g-5 mt-2 py-5">
        <div class="col-10 col-sm-8 col-lg-6 py-md-5 my-md-5">
          <img id="scooter" src="images/scooter.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700"
  ...
  <section class="footer-2">
    <footer class="container footer-2-container  d-flex align-items-center">
      ...
      <div class="col-md-4">
      <p class="footer2-paragraph">© <?php echo date('Y'); ?> Tasmim Web. All rights reserved.</p>
